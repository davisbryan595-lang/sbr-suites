      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="px-6 py-2 bg-primary text-primary-foreground font-bold rounded-full hover:bg-primary/90 hover:shadow-lg transition-all duration-300"
            >
              Inquire
            </button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4 bg-secondary rounded-lg p-4 border border-primary/20">
            ...
            <button
              onClick={() => scrollToSection("inquire")}
              className="w-full px-6 py-2 bg-primary text-primary-foreground font-bold rounded-full hover:bg-primary/90 transition-colors"
            >
              Inquire
            </button>
          </div>
